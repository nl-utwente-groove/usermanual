...
The \Groove{} samples contain the following rule systems showing various
aspects of the features discused above:
%
\begin{itemize}\noitemsep
...
outgoing transitions are preserved. See also rule system \textsf{mergers} in
the \Groove{} samples.
...
See also rule system \textsf{counting} in the \Groove{} samples.
