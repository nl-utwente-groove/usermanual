...
The situation is different if the parameter node is an attribute node, for as
...
\fref{parameter} shows an Edit and Display view of a rule woth two parameters,
...
\begin{figure}
\begin{center}
\graphbox{parameter-edit-view} \qquad
\graphbox{parameter} \qquad
